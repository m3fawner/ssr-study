...
const Diversification = ({ diversification }) => (
  <>
    <Head title="Diversification" description="A brief article describing diversification with regards to investments." url="/diversification" />
...
export const getStaticProps = async () => ({
  props: {
    diversification: await getMarkdown('asset-allocation'),
  },
});
